...
<head>
    ...
    <link rel="stylesheet" href="statics/js/layer/layer.css?v=3.1.0" id="layuicss-layer">
        ...
        <div class="scroll_box" style="height: 865px;">
            ...
            <div class="lottery_box">
                <div class="lottery_top">
                    ...
                    <div class="user">
                        <a href="{{ route('me') }}}" title=""><i class="iconfont icon-money"></i><em id="so_du">{{
                                number_format(auth()->user()->balance) }}</em> VNĐ</a>
                    </div>
                </div>
                    ...
                    <ul id="kq_loto">
                        ...
                        <li>
                            ...
                            <span>
                                ...
                                <em>{{ $loto->result > 15 ? 'Lớn' : 'Nhỏ' }}</em><em>{{ $loto->result %2 === 0 ? 'Chẵn'
                                    : 'Lẻ' }}</em>
                            </span>
                        </li>
                        @endforeach
            ...
            <div class="chat_box" style="height: 744px;" id="chat_box">
                <ul id="users">
                    {{-- <li>
                        <h5>13:29:23</h5>
                        <h4>w**4</h4>--}}
                        {{-- <div class="msg"><span class="qishu">Phiên 1402593</span>
                            <span--}} {{-- class="money">11.100.000 VNĐ</span><span class="wanfa">5</span>
                        </div>--}}
                        {{--
                    </li>--}}
                </ul>
            ...
            <div class="popup_box_m">
                <div class="popup_chat">
                    ...
                    <div class="btnbox"><input id="popup_chat_submit" type="button" class="btn" value="确 定"><a
                            href="javascript:$('.popup_chat_wrap').hide();" class="btn cancel ng-binding">Hủy bỏ</a>
                    </div>
                </div>
            </div>
        </div>
    </div>
    <script type="text/javascript" src="statics/js/Replacement_pc28.js">
    </script>
